...
class Chat extends StreamlitComponentBase {
  public render = (): ReactNode => {
    ...
    if (isUser) {
      // avatarUrl = `https://api.dicebear.com/5.x/${avatarStyle}/svg?seed=${seed}`;
      avatarUrl = "https://i.ibb.co/d76Kf1r/Picture2.png";
    } else {
      avatarUrl = "https://i.ibb.co/cCP3nrP/logo.png"; // Set the default image path here
    }
