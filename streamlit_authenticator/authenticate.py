...
class Authenticate:
    ...
    """
    def __init__(self, credentials: dict, cookie_obj: dict,  
        ...
        self.cookie_name = cookie_obj['name']
        self.key = cookie_obj['key']
        self.cookie_expiry_days = cookie_obj['expiry_days']
